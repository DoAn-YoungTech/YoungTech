...
import zalopay from "../../../public/designImage/imageLogo/logoPay/logo-zalopay.svg";
import momo from "../../../public/designImage/imageLogo/logoPay/momo-icon.png";
import vnpay from "../../../public/designImage/imageLogo/logoPay/vnpay.png";
import Image from "next/image";
import image1 from "../../../public/designImage/imageProducts/Mobile Devices/Tablets/apple-ipad-air-11-2024.jpg";
import image2 from "../../../public/designImage/imageProducts/Mobile Devices/Tablets/apple-ipad-air-13-2024.jpg";
...
const Page = () => {
  return (
    <section style={textFont} className="pay lg:container mt-[50px] m-auto">
              ...
              <Link href="#">
                <div className="method flex items-center">
                  <input
                    ...
                    className="w-6 h-6"
                  />
                  <Image src={momo} className="mx-5 w-[40px] h-[40px]" />
                  <div className="grid">
                    <span className="text-[16px] text-black">
                      Ví điện tử MoMo
                    </span>
              ...
              <Link href="#">
                <div className="method flex items-center">
                  <input
                    ...
                    className="w-6 h-6"
                  />
                  <Image src={zalopay} className="mx-5 w-[40px] h-[40px]" />
                  <div className="grid">
                    <span className="text-[16px] text-black">
                      Ví điện tử ZaloPay
                    </span>
              ...
              <Link href="#">
                <div className="method flex items-center">
                  <input
                    ...
                    className="w-6 h-6"
                  />
                  <Image src={vnpay} className="mx-5 w-[50px]" />
                  <div className="grid">
                    <span className="text-[16px] text-black">
                      Ví điện tử VNPAY
                    </span>

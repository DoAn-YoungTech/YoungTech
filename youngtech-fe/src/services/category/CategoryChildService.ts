...
export const addChildCategory = async (data) => {
    ...
    try {
        const response = await axios.post(`${Api_url}/childcategories`, data ,{headers});
...
export const getChildCategoryById = async (id) => {
    const headers = await getAuthHeaders();
    try {
        const response = await axios.get(`${Api_url}/childcategories/${id}`, {headers});
...
export const updateChildCategory = async (id, updatedCategoryChild) => {
    const headers = await getAuthHeaders();
    try {
        const response = await axios.put(`${Api_url}/childcategories/${id}`, updatedCategoryChild, {headers});
...
export const deleteChildCategory = async (id) => {
    const headers = await getAuthHeaders();
    try {
        const response = await axios.delete(`${Api_url}/childcategories/${id}`,{headers});
